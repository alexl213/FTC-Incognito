...
public class TwoWheelTrackingLocalizer extends TwoTrackingWheelLocalizer {
    ...
    public static double PARALLEL_X = 1.625; // X is the up and down direction
    ...
    public TwoWheelTrackingLocalizer(HardwareMap hardwareMap, SampleMecanumDrive drive) {
        ...
        parallelEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "fright_Drive"));
        perpendicularEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "bleft_Drive"));
