...
@Autonomous(name = "AdjustableFarBlue")

public class AdjustableFarBlue extends LinearOpMode {
...
//            telemetry.update();
        ...
        Trajectory farright6 = drive.trajectoryBuilder(rightPose2)
                .forward(-14.0)
                .splineTo(new Vector2d(48, 43.0), Math.toRadians(0.0))
                .build();
        ...
        Trajectory farleft6 = drive.trajectoryBuilder(farleft5.end())
                .forward(-14.0)
                .splineTo(new Vector2d(48, -32.0), Math.toRadians(0.0))
                .build();
        ...
        Trajectory farforward4 = drive.trajectoryBuilder(farforward3.end())
                .strafeRight(48.0)
                .build();
        Trajectory farforward5 = drive.trajectoryBuilder(forwardPose2)
                .forward(-14.0)
                .splineTo(new Vector2d(48.5, -35.0), Math.toRadians(0.0))
                .build();
        Trajectory farforward6 = drive.trajectoryBuilder(farforward5.end())
                .strafeRight(29.0)
                .build();
